...
import com.zzyl.hospital.vo.MonitoringDevicePropertyReportVo;
...
public class AmqpClient implements ApplicationRunner {
    ...
    private void processMessage(Message message) {
        ...
        NotifyData notifyData = JSONUtil.toBean(jsonNotifyData, NotifyData.class);
        if (ObjectUtil.isEmpty(notifyData.getBody()) || ObjectUtil.isEmpty(notifyData.getBody().getServices())) {
            return;
        }

        vitalSignDataService.batchInsertVitalSignData(notifyData);
    }
