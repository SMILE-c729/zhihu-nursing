package com.zzyl.hospital.config;
...
public class WebSocketServer {
     ...
     * 发送websocket消息给指定消费者
     *
     * @param warningNotifyVo 预警消息
     * @param userIds   预警数据map
     * @throws IOException io异常
     */
    public void sendMessageToConsumer(WarningNotifyVo warningNotifyVo, Collection<Long> userIds) {
        //如果消费者为空，程序结束
        ...
        userIds.forEach(userId -> {
            ...
            try {
                session.getBasicRemote().sendText(JSONUtil.toJsonStr(warningNotifyVo));
            } catch (IOException e) {
