...
@Data
@ApiModel("设备详情响应模型")
public class MonitoringDeviceDetailVo {
    ...
    /**
     * 绑定位置,如果是随身设备为患者ID，如果是固定设备为位置的最后一级id
     */
    @ApiModelProperty(value = "绑定位置,如果是随身设备为患者ID，如果是固定设备为位置的最后一级id")
    ...
    private String monitoringDeviceStatus;
