...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value="AdmissionContract对象", description="合同")
public class AdmissionContract extends BaseEntity
{
    ...
    private String admissionContractNo;
